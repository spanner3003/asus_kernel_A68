...
extern pgd_t *_pgd_alloc(struct mm_struct *mm,pgd_t *new_pgd);
extern void _pgd_free(struct mm_struct *mm, pgd_t *pgd_base);
// ASUS_BSP --- Thomas & Tingyi "[A68][Monkey] Preallocate mem for cpu on"
