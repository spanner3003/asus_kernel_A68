...
static struct i2c_board_info cm36283_i2c_info[] __initdata = {
    {
...
static struct i2c_board_info al3010_P03_i2c_info[] __initdata = {
    {
...
static struct rmi_device_platform_data s3202_platformdata = {
	...
	.level_triggered = true,	//ASUS_BSP simpson: add for improve IRQ stability ++
};
...
static void apq8064_mpuirq_init(void)
{
	...
	pr_info("*** MPU START *** enterprise_mpuirq_init...\n");
        ...
        default:
            printk(KERN_ERR "%s: unknow HWID, get sensor orientation failed!\n",__func__);
            break;
...
//ASUS_BSP	enable_ddr3_regulator();
	if (machine_is_apq8064_mtp()) {
	...
	if (machine_is_apq8064_mtp()) {
		...
		msm_hsic_pdata.log2_irq_thresh = 3;
		//ASUS_BSP--- BennyCheng "separate ITC settings of HSIC and USB1"
