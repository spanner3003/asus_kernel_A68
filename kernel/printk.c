...
module_param_named(console_suspend, console_suspend_enabled, bool, S_IRUGO | S_IWUSR); //Ledger
...
void suspend_console(void)
{
	...
	ASUSEvtlog("Entering suspend state LP0\n");
