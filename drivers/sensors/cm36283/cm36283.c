...
//A68 
static int g_max_light_level = 16;
static int g_cm36283_light_map[16] = {0,50,100,150,200,250,300,350,450,550,700,850,1050,1250,1500,2200} ;
...
static int cm36283_suspend(struct i2c_client *client, pm_message_t mesg)
{
    //printk("[cm36283]: cm36283_suspend. (GPIO0=%d)\n", gpio_get_value(g_proxm_int_pin));
    //printk("[cm36283]: GPIO0 , mfpr=0x%x , GPIOPLR0=0x%x , GPIOPDR0=0x%x \n", __raw_readl(0xFE01E0DC), __raw_readl(0xFE019000+0x0000), __raw_readl(0xFE019000+0x000C));
...
static int cm36283_resume(struct i2c_client *client)
{
//  printk("[cm36283]: cm36283_resume. (GPIO0=%d)\n", gpio_get_value(g_proxm_int_pin));
//  printk("[cm36283]: GPIO0 , mfpr=0x%x , GPIOPLR0=0x%x , GPIOPDR0=0x%x \n", __raw_readl(0xFE01E0DC), __raw_readl(0xFE019000+0x0000), __raw_readl(0xFE019000+0x000C));
