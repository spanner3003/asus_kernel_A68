...
const char *video_format_2string(uint32 format)
{
    ...
    case HDMI_VFRMT_1920x1200p60_16_10: return "1920x 1200 p60 16/10";//Mickey
...
struct hdmi_disp_mode_timing_type
    ...
    VFRMT_NOT_SUPPORTED(HDMI_VFRMT_1920x1200p60_16_10),//Mickey
};
...
//ASUS_BSP +++ for CTS HDCP test
//	if (MHL_HDCP_Mode)
//	{
//		if ( video_format != HDMI_VFRMT_720x480p60_16_9 )
//		{
//			  printk("(not 480p , return) add_supported_video_format check : format: %d [%s], %s\n", video_format, video_format_2string(video_format), supported ? "Supported" : "Not-Supported");
//		      return;
//		}	
//	}
//	else		
