...
./release-tools/mkbootimg --cmdline "console=ttyHSL0,115200,n8 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 maxcpus=2" --kernel $BIN_DIR/kernel  --ramdisk $BIN_DIR/ramdisk-$IMAGE_NAME.gz --base 0x80200000 --pagesize 2048 --ramdiskaddr 0x81500000 --output $BIN_DIR/$IMAGE_NAME.img
